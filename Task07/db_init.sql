...
('Иван', 'Петров', 'Сергеевич', 1, 35.0, 1, '2020-01-15', '+7-900-123-45-67', 'petrov@clinic.ru'),
('Мария', 'Сидорова', 'Александровна', 2, 40.0, 1, '2019-03-20', '+7-900-234-56-78', 'sidorova@clinic.ru'),
('Алексей', 'Козлов', 'Владимирович', 3, 30.0, 1, '2021-06-10', '+7-900-345-67-89', 'kozlov@clinic.ru'),
('Елена', 'Новикова', 'Игоревна', 1, 32.5, 1, '2020-09-01', '+7-900-456-78-90', 'novikova@clinic.ru'),
('Дмитрий', 'Морозов', 'Петрович', 6, 45.0, 1, '2018-11-05', '+7-900-567-89-01', 'morozov@clinic.ru'),
('Ольга', 'Волкова', 'Сергеевна', 4, 28.0, 0, '2019-05-12', '+7-900-678-90-12', 'volkova@clinic.ru');
...
('Удаление зуба простое', 30, 2000.0, 3, 'Удаление зуба без осложнений'),
...
('Коронка металлокерамическая', 90, 15000.0, 5, 'Изготовление и установка коронки'),
...
(1, 1, '2024-01-15', '10:00', 'Смирнов А.В.', '+7-911-111-11-11', 'completed', '2024-01-10 14:30:00'),
(1, 2, '2024-01-15', '11:00', 'Кузнецова Е.П.', '+7-911-222-22-22', 'completed', '2024-01-11 09:15:00'),
(2, 4, '2024-01-16', '14:00', 'Попов И.С.', '+7-911-333-33-33', 'scheduled', '2024-01-12 16:20:00'),
(3, 9, '2024-01-17', '10:00', 'Васильева М.А.', '+7-911-444-44-44', 'scheduled', '2024-01-13 11:00:00'),
(4, 1, '2024-01-15', '15:00', 'Петров Д.Н.', '+7-911-555-55-55', 'completed', '2024-01-10 18:00:00'),
(5, 6, '2024-01-18', '09:00', 'Соколов В.И.', '+7-911-666-66-66', 'scheduled', '2024-01-14 10:30:00'),
(1, 8, '2024-01-16', '10:00', 'Михайлов А.Б.', '+7-911-777-77-77', 'scheduled', '2024-01-13 15:45:00'),
(4, 2, '2024-01-16', '16:00', 'Федорова О.Л.', '+7-911-888-88-88', 'scheduled', '2024-01-14 09:00:00'),
(2, 5, '2024-01-17', '11:00', 'Николаев С.В.', '+7-911-999-99-99', 'scheduled', '2024-01-14 14:20:00'),
(5, 12, '2024-01-19', '10:00', 'Орлов П.М.', '+7-911-000-00-00', 'scheduled', '2024-01-15 12:00:00');
...
(1, 1, 1, '2024-01-15', '10:00', 'Смирнов А.В.', 'Консультация проведена, назначено лечение'),
(2, 1, 2, '2024-01-15', '11:15', 'Кузнецова Е.П.', 'Кариес вылечен, установлена пломба'),
(5, 4, 1, '2024-01-15', '15:00', 'Петров Д.Н.', 'Консультация, рекомендована чистка'),
(NULL, 1, 8, '2024-01-10', '14:00', 'Иванов К.С.', 'Профессиональная чистка выполнена'),
(NULL, 2, 4, '2024-01-12', '16:00', 'Лебедев А.П.', 'Удален зуб мудрости'),
(NULL, 4, 3, '2024-01-13', '10:00', 'Семенова Л.В.', 'Лечение пульпита завершено'),
(NULL, 5, 6, '2024-01-11', '11:00', 'Григорьев М.Н.', 'Имплантат установлен успешно'),
(NULL, 1, 2, '2024-01-14', '13:00', 'Тихонов В.А.', 'Лечение кариеса, пломба установлена'),
(NULL, 3, 9, '2024-01-08', '10:00', 'Романова И.С.', 'Брекет-система установлена'),
(NULL, 4, 8, '2024-01-09', '15:00', 'Зайцев Д.О.', 'Профессиональная чистка');
